...
export default function InstructorCourses() {
  ...
  return (
    <InstructorLayout>
      {/* <form className='text-center' onSubmit={(event) => offerCourse(event)}>
      <SelectField
      label={"Courses"}
      value={""}
        options={allCourses.map((item) => item.title)}
      />
      <button className="btn btn-sm btn-secondary">Offer</button>
      </form> */}
      <OfferCourseTable
